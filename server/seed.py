...
with app.app_context():
    ...
    car22 = Car(make="Audi", model="A4", year=2018, price=28000, used=False, image="https://s3.us-east-2.amazonaws.com/dealer-inspire-vps-vehicle-images/296d-110006756/WAUENAF42JA168948/8665ac66d324481d3f391792f7023065.jpg")
    car23 = Car(make="Mercedes-Benz", model="C300", year=2019, price=35000, used=False, image="https://www.sansoneskia.com/assets/stock/expanded/transparent/640/2017mbc890003_640/2017mbc890003_640_01.png?height=400&bg-color=FFFFFF")
